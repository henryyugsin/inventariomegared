...
public class cajas {
    ...
    public cajas(int id,String codp,String cods,String descripcion,int cantxu,int lote,int cantbod,int canttec,int cantinst,int ntransf ){
        this.id=id;
        this.codp=codp;
        this.cods=cods;
    ...
    public void registrar(){
        ...
        PreparedStatement ps = con.prepareStatement("INSERT INTO cajas (codp,cods,descripcion,cantxu,lote,cantbod,canttec,cantinst,ntransf) VALUES (?,?,?,?,?,?,?,?,?)");
        ps.setString(1,codp);
        ps.setString(2,cods);
    ...
    try{
        ...
        PreparedStatement ps = cont.prepareStatement("UPDATE cajas SET codp=?,descripcion=?,cantxu=?,lote=?,cantbod=?,canttec=?,cantinst=?,ntransf=?  WHERE cods=?");
        ps.setString(1,codp);
    ...
    try{
        Connection con =  ConexionMySQL.getConexion();
        PreparedStatement psu = con.prepareStatement("DELETE FROM cajas WHERE cods=?");
