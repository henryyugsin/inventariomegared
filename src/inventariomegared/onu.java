...
public class onu {
    ...
    public int tact;
    public int ntran;
    public onu(int id, String sn, String pon, String modelo, String lote, String estado, int tact, int ntran){
        this.id=id;
        this.sn=sn;
        this.pon=pon;
        this.modelo=modelo;
    ...
    public void registrar(){
       ...
       try{
        ...
        PreparedStatement ps1 = con1.prepareStatement("INSERT INTO onu (sn,pon,modelo,lote,estado,tact,ntran) VALUES (?,?,?,?,?,?,?)");
        ps1.setString(1,sn);
        ps1.setString(2,pon);
    ...
    try{
        ...
        PreparedStatement ps = cont.prepareStatement("UPDATE onu SET pon=?, modelo=?, lote=?, estado=?, tact=?, ntran=?  WHERE sn=?");
        ps.setString(1,pon);
    ...
    try{
        Connection con =  ConexionMySQL.getConexion();
        PreparedStatement psu = con.prepareStatement("DELETE FROM onu WHERE pon=?");
        psu.setString(1,pon);
        psu.executeUpdate();
   ...
   public int consultar2(){
       ...
       int iaux=0;
        ...
        PreparedStatement ps;
        ResultSet rs;
        ps = con.prepareStatement("SELECT * FROM onu WHERE sn=?");
        ps.setString(1,sn);
        rs=ps.executeQuery();
   while(rs.next()){
       iaux=1;
