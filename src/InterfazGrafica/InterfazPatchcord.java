...
import inventariomegared.patchcord;
...
public class InterfazPatchcord extends javax.swing.JFrame {


    public InterfazPatchcord() {
        initComponents();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        patchcord patch=new patchcord(0,codp,cods,descripcion,cantxu,lote,cantbod,canttec,cantinst,ntransf);
        patch.registrar();
        limpiardatos();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        String cods=codstxt.getText();
        patchcord patch=new patchcord(0,"",cods,"",0,0,0,0,0,0);
        patch.consultar();
        idtxt.setText(""+patch.id);
        codptxt.setText(patch.codp);
        codstxt.setText(patch.cods);
        descripciontxt.setText(patch.descripcion);
        cantxutxt.setText(""+patch.cantxu);
        jComboBox1.setSelectedItem(""+patch.lote);
        cantbodtxt.setText(""+patch.cantbod);
        canttectxt.setText(""+patch.canttec);
        cantinsttxt.setText(""+patch.cantinst);
        ntransftxt.setText(""+patch.ntransf);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        int cantinst =Integer.parseInt(cantinsttxt.getText());
        int ntransf =Integer.parseInt(ntransftxt.getText());
        patchcord patch=new patchcord(id,codp,cods,descripcion,cantxu,lote,cantbod,canttec,cantinst,ntransf);
        patch.modificar();
        limpiardatos();
   ...
   modeloTabla.addRow(fila);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new InterfazPatchcord().setVisible(true);
            }
        });
    }
