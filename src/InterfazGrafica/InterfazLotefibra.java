...
import inventariomegared.lotefibra;
...
public class InterfazLotefibra extends javax.swing.JFrame {


    public InterfazLotefibra() {
        initComponents();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        lotefibra lot=new lotefibra(1,proveedor,fechainicio,nfactura,descripcion);
        lot.registrar();
        iniciarvalores();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        String nfactura=nfacturatxt.getText();
        lotefibra lot=new lotefibra(1,"",null,nfactura,"");
        lot.consultar();
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        long dinicio = fechallegada.getTime();
        java.sql.Date fechainicio= new java.sql.Date(dinicio);
        lotefibra lot=new lotefibra(id,proveedor,fechainicio,nfactura,descripcion);
        lot.modificar();
        iniciarvalores();
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        // TODO add your handling code here:
        int id=Integer.parseInt(idtxt.getText());
        lotefibra lot=new lotefibra(id,"",null,"","");
        lot.eliminar();
        iniciarvalores();
   ...
   modeloTabla.addRow(fila);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InterfazLotefibra.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new InterfazLotefibra().setVisible(true);
            }
        });
    }
