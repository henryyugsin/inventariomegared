...
import inventariomegared.usuarios;
...
public class InterfazUsuarios extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        InterfazAñadirUsuario rusu =new InterfazAñadirUsuario();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if(id==1){
            JOptionPane.showMessageDialog(null, "No se puede Eliminar al usuario Administrador");
        }else{
            usuarios usu2 = new usuarios(id,nombre,usuario,"");
            usu2.eliminar();
            cargarTabla();
        }
