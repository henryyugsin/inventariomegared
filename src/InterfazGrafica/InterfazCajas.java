...
import inventariomegared.cajas;
...
public class InterfazCajas extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        cajas caja=new cajas(0,codp,cods,descripcion,cantxu,lote,cantbod,canttec,cantinst,ntransf);
        caja.registrar();
        limpiardatos();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        String cods=codstxt.getText();
        cajas caja=new cajas(0,"",cods,"",0,0,0,0,0,0);
        caja.consultar();
        idtxt.setText(""+caja.id);
        codptxt.setText(caja.codp);
        codstxt.setText(caja.cods);
        descripciontxt.setText(caja.descripcion);
        cantxutxt.setText(""+caja.cantxu);
        jComboBox1.setSelectedItem(""+caja.lote);
        cantbodtxt.setText(""+caja.cantbod);
        canttectxt.setText(""+caja.canttec);
        cantinsttxt.setText(""+caja.cantinst);
        ntransftxt.setText(""+caja.ntransf);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        int cantinst =Integer.parseInt(cantinsttxt.getText());
        int ntransf =Integer.parseInt(ntransftxt.getText());
        cajas caja=new cajas(id,codp,cods,descripcion,cantxu,lote,cantbod,canttec,cantinst,ntransf);
        caja.modificar();
        limpiardatos();
   ...
   modeloTabla.addRow(fila);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new InterfazCajas().setVisible(true);
            }
        });
    }
