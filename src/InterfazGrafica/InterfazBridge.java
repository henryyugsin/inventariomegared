...
public class InterfazBridge extends javax.swing.JFrame {

    public InterfazBridge() {
        initComponents();
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        String pon=jTable1.getValueAt(fila, 2).toString();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        bridge brid=new bridge(id,sn,pon,modelo,lote,estado,tact,ntrans);
        brid.registrar();
        sntxt.setText("");
        pontxt.setText("");
        cargarTabla();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        String pon=pontxt.getText();
        bridge brid=new bridge(1,"",pon,"","","",0,0);
        brid.consultar();
        idtxt.setText(""+brid.id);
        sntxt.setText(brid.sn);
        pontxt.setText(brid.pon);
        modelojcombobox.setSelectedItem(brid.modelo);
        lotejcombobox.setSelectedItem(brid.lote);
        estadojcombobox.setSelectedItem(brid.estado);
        tacttxt.setText(""+brid.tact);
        ntranstxt.setText(""+brid.ntran);
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        int tact=Integer.parseInt(tacttxt.getText());
        int ntrans=Integer.parseInt(ntranstxt.getText());
        bridge brid=new bridge(1,sn,pon,modelo,lote,estado,tact,ntrans);
        brid.modificar();
        rvalores();
   ...
   modeloTabla.addRow(fila);
    ...
    try{
        ...
        PreparedStatement ps;
        ResultSet rs;
        ps = con.prepareStatement("SELECT modelo.modelo FROM modelo where tipo='BRIDGE'");
        rs=ps.executeQuery();
        while (rs.next()){
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new InterfazBridge().setVisible(true);
            }
        });
    }
