...
public class InterfazRegistrarUsuAdmin extends javax.swing.JFrame {


    public InterfazRegistrarUsuAdmin() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("AÑADIR USUARIO ADMINISTRADOR");
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(txtcontraseña2, javax.swing.GroupLayout.DEFAULT_SIZE, 165, Short.MAX_VALUE))
                .addContainerGap())
        );
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(contraseña2.equals(contraseña)){
            if (contraseña.length()>=8){
                usuarios usu=new usuarios(1,nombre,usuario,contraseña);
                usu.registrar();
                txtnombre.setText("");
                txtusuario.setText("");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InterfazRegistrarUsuAdmin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new InterfazRegistrarUsuAdmin().setVisible(true);
            }
        });
    }
