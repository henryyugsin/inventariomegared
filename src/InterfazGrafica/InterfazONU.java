...
public class InterfazONU extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        onu on=new onu(id,sn,pon,modelo,lote,estado,tact,ntrans);
        on.registrar();
        sntxt.setText("");
        pontxt.setText("");
        cargarTabla();
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        int tact=Integer.parseInt(tacttxt.getText());
        int ntrans=Integer.parseInt(ntranstxt.getText());
        onu on=new onu(1,sn,pon,modelo,lote,estado,tact,ntrans);
        on.modificar();
        rvalores();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        String pon=pontxt.getText();
        onu on=new onu(1,"",pon,"","","",0,0);
        on.consultar();
        idtxt.setText(""+on.id);
        sntxt.setText(on.sn);
        pontxt.setText(on.pon);
        modelojcombobox.setSelectedItem(on.modelo);
        lotejcombobox.setSelectedItem(on.lote);
        estadojcombobox.setSelectedItem(on.estado);
        tacttxt.setText(""+on.tact);
        ntranstxt.setText(""+on.ntran);
   ...
   modeloTabla.addRow(fila);
    ...
    try{
        ...
        PreparedStatement ps;
        ResultSet rs;
        ps = con.prepareStatement("SELECT modelo.modelo FROM modelo where tipo='ONU'");
        rs=ps.executeQuery();
        while (rs.next()){
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new InterfazONU().setVisible(true);
            }
        });
    }
