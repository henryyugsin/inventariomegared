...
import inventariomegared.router;
...
public class InterfazRouter extends javax.swing.JFrame {


    public InterfazRouter() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "SN", "MODELO", "LOTE", "ESTADO", "TRANS. ACT", "N.TRANS"
            }
        ) {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        router rout=new router(id,sn,modelo,lote,estado,tact,ntrans);
        rout.registrar();
        snptxt.setText("");
        cargarTabla();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        String sn=snptxt.getText();
        router rout=new router(0,sn,"","","",0,0);
        rout.consultar();
        idtxt.setText(""+rout.id);
        snptxt.setText(rout.sn);
        modelojcombobox.setSelectedItem(rout.modelo);
        lotejcombobox.setSelectedItem(rout.lote);
        estadojcombobox.setSelectedItem(rout.estado);
        tacttxt.setText(""+rout.tact);
        ntranstxt.setText(""+rout.ntran);
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        int tact=Integer.parseInt(tacttxt.getText());
        int ntrans=Integer.parseInt(ntranstxt.getText());
        router rout=new router(1,snp,modelo,lote,estado,tact,ntrans);
        rout.modificar();
        rvalores();
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        String sn=jTable1.getValueAt(fila, 1).toString();
        String modelo=jTable1.getValueAt(fila, 2).toString();
        String lote=jTable1.getValueAt(fila, 3).toString();
        String estado=jTable1.getValueAt(fila, 4).toString();
        String tact=jTable1.getValueAt(fila, 5).toString();
        String ntran=jTable1.getValueAt(fila, 6).toString();
        idtxt.setText(id);
        snptxt.setText(sn);
   ...
   modeloTabla.addRow(fila);
    ...
    try{
        ...
        PreparedStatement ps;
        ResultSet rs;
        ps = con.prepareStatement("SELECT modelo.modelo FROM modelo where tipo='ROUTER'");
        rs=ps.executeQuery();
        while (rs.next()){
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new InterfazRouter().setVisible(true);
            }
        });
    }
