...
public class InterfazDevolucion extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                .addGap(31, 31, 31)
                .addComponent(codigotxt, javax.swing.GroupLayout.PREFERRED_SIZE, 329, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(48, 48, 48)
        ...
        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "DIRECTO", "NO DIRECTO" }));
    ...
    public void modificarinventario(){
        ...
        String precibe=txtusuario.getText();
        String pentrega=nombretxt.getText();
        String tipo=jComboBox1.getSelectedItem().toString();
        String descripcion=descripciontxt.getText();
        //Obtener la fecha
        java.util.Date utilDate = new java.util.Date();
        java.sql.Date sqlDate = new java.sql.Date(utilDate.getTime());
        transferencias transf=new transferencias(0,pentrega,precibe,tipo,sqlDate, descripcion);
    ...
    String matriz[][]=new String[numerodefilas][4];
        ...
        for(int i = 0; i < numerodefilas; i++) {
          ...
          switch (identificador.toLowerCase()) {
          case "onu":
              modificaciones modonu=new modificaciones(matriz[i][0],"BODEGA",transfact,1);
              modonu.modificaronu();  
          break;
          case "bridge":
              modificaciones modbridge=new modificaciones(matriz[i][0],"BODEGA",transfact,1);
              modbridge.modificarbridge();  
          break;
          case "router":
              modificaciones modrouter=new modificaciones(matriz[i][0],"BODEGA",transfact,1);
              modrouter.modificarrouter();  
          break;
          case "mesh":
              modificaciones modmesh=new modificaciones(matriz[i][0],"BODEGA",transfact,1);
              modmesh.modificarmesh();  
          break;
          case "antena":
              modificaciones modantena=new modificaciones(matriz[i][0],"BODEGA",transfact,1);
              modantena.modificarantena();  
          break;
          case "switch":
              modificaciones modswitc=new modificaciones(matriz[i][0],"BODEGA",transfact,1);
          ...
          case "bobinas":
              ...
              if(cond.equals("DIRECTO")){ 
                cantbob.modificarbobinas6(cantidadbobina);
              }else{
                  cantbob.modificarbobinas5(cantidadbobina);
              } 
          break;
          case "spliters":
              ...
              if(conds.equals("DIRECTO")){ 
                cantsplites.modificarspliters6(cantidadspliters);
              }else{
                  cantsplites.modificarspliters5(cantidadspliters);
              } 
          break;
          case "cajas":
              ...
              if(condc.equals("DIRECTO")){ 
                cantcajas.modificarcajas6(cantidadcajas);
              }else{
                  cantcajas.modificarcajas5(cantidadcajas);
              }
          break;
          case "patchcord":
              ...
              if(condp.equals("DIRECTO")){ 
                cantpatchcord.modificarpatchcord6(cantidadpatchcord);
              }else{
                  cantpatchcord.modificarpatchcord5(cantidadpatchcord);
              }
          break;
          case "ganchos":
              ...
              if(condg.equals("DIRECTO")){ 
                cantganchos.modificarganchos6(cantidadganchos);
              }else{
                  cantganchos.modificarganchos5(cantidadganchos);
              }
          ...
          case "otros":
              ...
              if(condo.equals("DIRECTO")){ 
                cantotros.modificarotros6(cantidadotros);
              }else{
                  cantotros.modificarotros5(cantidadotros);
              }
