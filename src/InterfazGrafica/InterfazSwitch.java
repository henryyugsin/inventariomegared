...
import inventariomegared.switc;
...
public class InterfazSwitch extends javax.swing.JFrame {

    public InterfazSwitch() {
        initComponents();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        switc swit=new switc(id,sn,modelo,lote,estado,tact,ntrans);
        swit.registrar();
        snptxt.setText("");
        cargarTabla();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        String sn=snptxt.getText();
        switc swit=new switc(0,sn,"","","",0,0);
        swit.consultar();
        idtxt.setText(""+swit.id);
        snptxt.setText(swit.sn);
        modelojcombobox.setSelectedItem(swit.modelo);
        lotejcombobox.setSelectedItem(swit.lote);
        estadojcombobox.setSelectedItem(swit.estado);
        tacttxt.setText(""+swit.tact);
        ntranstxt.setText(""+swit.ntran);
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        int tact=Integer.parseInt(tacttxt.getText());
        int ntrans=Integer.parseInt(ntranstxt.getText());
        switc swit=new switc(1,snp,modelo,lote,estado,tact,ntrans);
        swit.modificar();
        rvalores();
   ...
   modeloTabla.addRow(fila);
    ...
    try{
        ...
        PreparedStatement ps;
        ResultSet rs;
        ps = con.prepareStatement("SELECT modelo.modelo FROM modelo where tipo='SWITCH'");
        rs=ps.executeQuery();
        while (rs.next()){
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new InterfazSwitch().setVisible(true);
            }
        });
    }
