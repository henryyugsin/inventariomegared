...
public class Interfaztransferid extends javax.swing.JFrame {

    public Interfaztransferid() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("TRANSFERENCIA ID");
...
ps = con.prepareStatement("SELECT * FROM transferencias where id='"+aux+"'");
   rs=ps.executeQuery();
   ...
   modeloTabla.addRow(fila);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Interfaztransferid.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Interfaztransferid().setVisible(true);
            }
        });
    }
