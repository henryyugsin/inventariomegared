...
import inventariomegared.antena;
...
public class InterfazAntena extends javax.swing.JFrame {


    public InterfazAntena() {
        initComponents();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        antena ant=new antena(0,sn,modelo,lote,estado,tact,ntrans);
        ant.registrar();
        snptxt.setText("");
        cargarTabla();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        String sn=snptxt.getText();
        antena ant=new antena(0,sn,"","","",0,0);
        ant.consultar();
        idtxt.setText(""+ant.id);
        snptxt.setText(ant.sn);
        modelojcombobox.setSelectedItem(ant.modelo);
        lotejcombobox.setSelectedItem(ant.lote);
        estadojcombobox.setSelectedItem(ant.estado);
        tacttxt.setText(""+ant.tact);
        ntranstxt.setText(""+ant.ntran);
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        int tact=Integer.parseInt(tacttxt.getText());
        int ntrans=Integer.parseInt(ntranstxt.getText());
        antena ant=new antena(1,snp,modelo,lote,estado,tact,ntrans);
        ant.modificar();
        rvalores();
   ...
   modeloTabla.addRow(fila);
    ...
    try{
        ...
        PreparedStatement ps;
        ResultSet rs;
        ps = con.prepareStatement("SELECT modelo.modelo FROM modelo where tipo='ANTENA'");
        rs=ps.executeQuery();
        while (rs.next()){
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new InterfazAntena().setVisible(true);
            }
        });
    }
