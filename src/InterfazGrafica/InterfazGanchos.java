...
import inventariomegared.Ganchos;
...
public class InterfazGanchos extends javax.swing.JFrame {

    public InterfazGanchos() {
        initComponents();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        Ganchos gancho=new Ganchos(0,codp,cods,descripcion,cantxu,lote,cantbod,canttec,cantinst,ntransf);
        gancho.registrar();
        limpiardatos();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        String cods=codstxt.getText();
        Ganchos gancho=new Ganchos(0,"",cods,"",0,0,0,0,0,0);
        gancho.consultar();
        idtxt.setText(""+gancho.id);
        codptxt.setText(gancho.codp);
        codstxt.setText(gancho.cods);
        descripciontxt.setText(gancho.descripcion);
        cantxutxt.setText(""+gancho.cantxu);
        jComboBox1.setSelectedItem(""+gancho.lote);
        cantbodtxt.setText(""+gancho.cantbod);
        canttectxt.setText(""+gancho.canttec);
        cantinsttxt.setText(""+gancho.cantinst);
        ntransftxt.setText(""+gancho.ntransf);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        int cantinst =Integer.parseInt(cantinsttxt.getText());
        int ntransf =Integer.parseInt(ntransftxt.getText());
        Ganchos gancho=new Ganchos(id,codp,cods,descripcion,cantxu,lote,cantbod,canttec,cantinst,ntransf);
        gancho.modificar();
        limpiardatos();
   ...
   modeloTabla.addRow(fila);
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new InterfazGanchos().setVisible(true);
            }
        });
    }
