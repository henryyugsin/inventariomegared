...
import inventariomegared.spliters;
...
public class InterfazSpliters extends javax.swing.JFrame {


    public InterfazSpliters() {
        initComponents();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        spliters spliter=new spliters(0,codp,cods,descripcion,cantxu,lote,cantbod,canttec,cantinst,ntransf);
        spliter.registrar();
        limpiardatos();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        String cods=codstxt.getText();
        spliters spliter=new spliters(0,"",cods,"",0,0,0,0,0,0);
        spliter.consultar();
        idtxt.setText(""+spliter.id);
        codptxt.setText(spliter.codp);
        codstxt.setText(spliter.cods);
        descripciontxt.setText(spliter.descripcion);
        cantxutxt.setText(""+spliter.cantxu);
        jComboBox1.setSelectedItem(""+spliter.lote);
        cantbodtxt.setText(""+spliter.cantbod);
        canttectxt.setText(""+spliter.canttec);
        cantinsttxt.setText(""+spliter.cantinst);
        ntransftxt.setText(""+spliter.ntransf);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        int cantinst =Integer.parseInt(cantinsttxt.getText());
        int ntransf =Integer.parseInt(ntransftxt.getText());
        spliters spliter=new spliters(id,codp,cods,descripcion,cantxu,lote,cantbod,canttec,cantinst,ntransf);
        spliter.modificar();
        limpiardatos();
   ...
   modeloTabla.addRow(fila);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new InterfazSpliters().setVisible(true);
            }
        });
    }
