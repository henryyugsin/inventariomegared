...
import inventariomegared.bobinas;
...
public class Interfazbobinas extends javax.swing.JFrame {

    public Interfazbobinas() {
        initComponents();
    ...
    private void initComponents() {
        ...
        unidatotxt = new javax.swing.JTextField();
        ...
        jLabel5.setText("CANTIDADxU(metros)");

        jLabel6.setText("LOTE");

        jLabel7.setText("CAN. BODEGA(Metros)");

        jLabel8.setText("CAN. INSTALADA(Metros)");

        jLabel9.setText("N. TRANSFERENCIAS");

        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "0" }));

        jLabel10.setText("CANTIDAD  T(Unidades)");

        jLabel11.setText("CAN. TECNICOS(Metros)");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addComponent(unidatotxt, javax.swing.GroupLayout.PREFERRED_SIZE, 141, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(unidatotxt, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(23, 23, 23)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "COD. PRIMARIO", "COD. SECUNDARIO", "DESCRIPCION", "CANT(Metros)", "UNI.T", "LOTE", "CAN DISPONIBLE", "CAN TECNICOS", "CAN UTILIZADA", "N.TRANSF"
            }
        ) {
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        InterfazLotefibra ilfibra=new InterfazLotefibra();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        int unidato =Integer.parseInt(unidatotxt.getText());
        ...
        bobinas bob=new bobinas(id,codp,cods,descripcion,cantxu,unidato,lote,cantbod,canttec,cantinst,ntransf);
        bob.registrar();
        limpiardatos();
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        String unidato=jTable1.getValueAt(fila, 5).toString();
        String lote=jTable1.getValueAt(fila, 6).toString();
        String cantbod=jTable1.getValueAt(fila, 7).toString();
        String canttec=jTable1.getValueAt(fila, 8).toString();
        String cantinst=jTable1.getValueAt(fila, 9).toString();
        String ntransf=jTable1.getValueAt(fila, 10).toString();
        idtxt.setText(id);
        codptxt.setText(codp);
        codstxt.setText(cods);
        descripciontxt.setText(descripcion);
        cantxutxt.setText(cantxu);
        unidatotxt.setText(unidato);
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        // TODO add your handling code here:
        String cods=codstxt.getText();
        bobinas bob=new bobinas(0,"",cods,"",0,0,0,0,0,0,0);
        bob.eliminar();
        limpiardatos();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        bobinas bob=new bobinas(0,"",cods,"",0,0,0,0,0,0,0);
        bob.consultar();
        idtxt.setText(""+bob.id);
        codptxt.setText(bob.codp);
        codstxt.setText(bob.cods);
        descripciontxt.setText(bob.descripcion);
        cantxutxt.setText(""+bob.cantxu);
        unidatotxt.setText(""+bob.unidato);
        jComboBox1.setSelectedItem(""+bob.lote);
        cantbodtxt.setText(""+bob.cantbod);
        canttectxt.setText(""+bob.canttec);
        cantinsttxt.setText(""+bob.cantinst);
        ntransftxt.setText(""+bob.ntransf);
   ...
   modeloTabla.addRow(fila);
    ...
    try{
        ...
        PreparedStatement ps;
        ResultSet rs;
        ps = con.prepareStatement("SELECT lotefibra.id FROM lotefibra");
        rs=ps.executeQuery();
        while (rs.next()){
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Interfazbobinas().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTextField unidatotxt;
