...
public class InterfazAnadirTecnico extends javax.swing.JFrame {


    public InterfazAnadirTecnico() {
        initComponents();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        tecnicos usu=new tecnicos(1,nombre,cedula);
        usu.registrar();
        txtnombre.setText("");
        txtusuario.setText("");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new InterfazAnadirTecnico().setVisible(true);
            }
        });
    }
